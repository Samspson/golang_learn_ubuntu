...
import (
	"bufio"
	"fmt"
	cg "github.com/go-training/go_basic/ch4/cgss/src/cg"
	ipc "github.com/go-training/go_basic/ch4/cgss/src/ipc"
	"strconv"
	"strings"
)

var conterClient *cg.CenterClient
...
func Login(args []string) int {
	...
	err = conterClient.AddPlayer(player)
	if err != nil {
...
func ListPlayer(args []string) int {
	ps, err := conterClient.ListPlayer("")
	if err != nil {
...
func Send(args []string) int {
	...
	err := conterClient.Broadcast(message)
	if err != nil {
		fmt.Println("Failed.", err)
	}
	return 0
