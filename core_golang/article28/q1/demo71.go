...
func main() {
	...
	fmt.Println()
	{
		...
		fmt.Println("[Three pairs have been stored int the sync.Map instance]")
		...
		k1 := pairs[1].k
		sMap.Delete(k1)
		fmt.Printf("[The pairs with the key of %v has been removed form the sync.Map instance]\n", k1)
		v1, ok := sMap.Load(k1)
		fmt.Printf("The result of Load: %v, %v (key: %v)\n", v1, ok, k1)
		v1 = pairs[1].v
