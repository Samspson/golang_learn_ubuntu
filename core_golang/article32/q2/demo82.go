...
func main() {
	...
	reader5c := strings.NewReader("Once all inputs have returned EOF, Reader will return EOF")
	reader5d := strings.NewReader("If any of the readers return a non-nil, " +
		"non-EOF error, Read wil return that error.")
