...
func main() {
	comment := "Because these interfaces and primitives wrap lower-level operations with various implementinons, " +
		"unless oherwise informed clients should not assume they are safe for parallel execution."
